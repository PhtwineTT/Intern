...
{
    /// <inheritdoc />
    public partial class UpdateModelTech : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistereAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TournamentRegistration", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TournamentRegistration_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentRegistration_TeamId",
